...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ja": {
        ...
        "mode_select": "モード選択",
        "mode_train": "オリジナルボイスモデル学習",
        "mode_tts": "音声合成",
        "mode_instant": "オリジナル音声即時合成",
        ...
        "instant_audio_help": "3 秒以上の音声ファイルを推奨します。",
    ...
    "en": {
        ...
        "train_audio_help": "Audio of 3 seconds or more is recommended.",
        ...
        "instant_audio_help": "Audio of 3 seconds or more is recommended.",
    ...
    "zh": {
        ...
        "tts_no_models": (
            "没有已保存的声音模型（{size}）。请先在『原创声音模型训练』模式中创建模型。"
        ),
        ...
        "instant_audio": "参考音频",
        "instant_audio_help": "建议使用 3 秒以上的音频文件。",
